...
export default class AdCard extends React.Component {
  ...
  save = () => {
    ...
    console.log(this.state.data);
    a.id = this.state.data.obj.pkAd;
    ajax('/api/ad/save', a, 'POST').then((response) => {
      this.setState({ updateMod: false });
      this.getData().then();
    });
  };
  ...
  async getData() {
    ...
    ajax('/api/ad/getOne', { id }, 'GET').then((q) => {
                  ...
                  <div className={'map-box'}>
                    ...
                    >
                      <Dragger
                        name={'file'}
                        multiple={false}
                        action="http://39.107.232.66:8080/PrintRoom/api/file/upload"
